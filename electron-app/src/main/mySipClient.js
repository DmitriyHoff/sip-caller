...
class MySipClient extends EventTarget {
  ...
  constructor(options) {
    ...
    const delegate = {
      onConnect: () => {
        console.log('Connect...')
        this.dispatchEvent(new Event('sip-connect'))
      },
      onDisconnect: (error) => {
        console.log('Disconnect: ', { error })
        this.dispatchEvent(new CustomEvent('sip-disconnect', error))
      },

      onInvite: (invitation) => {
        this.onIncomingCall(invitation)
        console.log('Invitation...', { invitation })
        this.dispatchEvent(new CustomEvent('sip-invite', invitation))
      },

      onMessage: (message) => {
        console.log('Message ', { message })
        this.dispatchEvent(new CustomEvent('sip-message', message))
      },

      onNotify: (notification) => {
        console.log('Notify ', { notification })
        this.dispatchEvent(new CustomEvent('sip-notify', notification))
      }
    }
    ...
    // this._mediaElement = new window.Audio()
  ...
  _setupRemoteMedia(invitation) {
    ...
    this.dispatchEvent(new CustomEvent('sip-setup-media', remoteStream))
  }
  ...
  _cleanupMedia() {
    ...
    this.dispatchEvent(new Event('sip-clear-media'))
  }
